...
//        startActivity(intent)
    ...
    inner class RecyclerViewAdapter : RecyclerView.Adapter<RecyclerViewAdapter.CustomViewHolder>() {
        ...
        private val chatModel = ArrayList<ChatFragment.ChatModel>()
            ...
            fireDatabase.child("chatrooms").orderByChild("users/$uid").equalTo(true).addListenerForSingleValueEvent(object :
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for(data in snapshot.children){
                        chatModel.add(data.getValue<ChatFragment.ChatModel>()!!)
                        println(data)
                    }
        ...
        override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
            ...
            val commentMap = TreeMap<String, ChatFragment.ChatModel.Comment>(reverseOrder())
